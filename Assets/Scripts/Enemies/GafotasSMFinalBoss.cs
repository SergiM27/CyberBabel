...
public class GafotasSMFinalBoss : EnemyController
{
    ...
    {
        health = 300 + (GameManager.currentEnemyMaxHPLevel * 4);
        movementSpeed = 3f + (GameManager.currentEnemyMovementSpeed * 0.1f);
        damage = 20 + (GameManager.currentEnemyAttackLevel * 3);
    }
